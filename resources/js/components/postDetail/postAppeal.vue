    ...
    <div>
        <section class="mt-2 pb-2">
            <div class="container">
                    ...
                    <div class="col-md-6 col-xxl-4 col-lg-4 col-xl-4 col-md-6 col-sm-12 col-xs-6"
                        ...
                        <div class="card h-100 card_getallnews p-2">
                            ...
                            <div class="row">
                                <div class="col">
                                        ...
                                        <img class="getallimg img-fluid"
                                            ...
                                            :alt="res.organization.title"  :title="res.organization.title">
                            ...
                            <a v-else type="button" class="read_more p-1" data-bs-toggle="modal"
                                data-bs-target="#myAppealReadModal" @click="getEditId(res.id)">Read More </a>
                            ...
                            res.total_view }}</span>
                                        ...
                                        <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 col-xxl-3 col-xl-3">
                                            <div class=" text-center" style="margin-left: 20px;">
                                                <a class="view_all_latestact" :href="`/sharepostcard?id=${btoa(res.id)}&type=${btoa('Appeal')}`" target="_blank"  @click.prevent="sendToWhatsApp( res.organization.title , `/sharepostcard?id=${btoa(res.id)}&type=${btoa('Appeal')}` )" id="share">
                ...
                <div class="modal" id="myAppealReadModal">
                            ...
                            <div class="modal-body" style="padding-bottom: 0%;">
                                <div class="row">
                                    <div class="col-md-12 col-lg-6 col-xl-6 col-xxl-6 col-sm-12 col-xs-12">
                                        ...
                                        <div class="swiper thumbnail thumbnailAppeal">
                                            <div class="swiper-wrapper">
                                                <div v-for="(res, index) in modelBanner" :key="index"
                                                    class="swiper-slide">
                                            ...
                                            <div class="next_div" v-if="modelBanner.length > 3" @click="nextSlideAppeal"><i
                                                    class="bi bi-chevron-right"></i></div>
                                            <div class="prev_div" v-if="modelBanner.length > 3" @click="prevSlideAppeal"><i
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="text-center">
                                                                ...
                                                                <br><span class="icon_font">{{ total_count > 0 ?
                                                                    total_count : detail_sanstha.total_like == null ? 0
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="text-center">
                                                                ...
                                                                <br><span class="icon_font ">{{
                                                                    detail_sanstha.total_view == null ? 0 :
                                                                    detail_sanstha.total_view }}</span>
                                                            </div>
                                                        </div>
                                                        <div
                                                            class="col-xs-3 col-sm-3 col-md-3 col-lg-3 col-xxl-3 col-xl-3 col-xxs-3">
...
export default {
    ...
    data() {
        return {
            ...
            appeal_id: '', token: localStorage.getItem('storeToken'), org_title: '', org_logo: '',
            appealTitle: '', appealPost_visiblity: '', selectedImageURL3: '', selectedImageURL2: '', org_detail: '', frm_img: '', appeal_data: [], appeal_page: 1, appeal_id: '', total_count: '', appealSanstha: []
        };
    },
    created() {
    ...
    mounted() {
        const thumbnathumbnailAppealil = new Swiper('.thumbnailAppeal', {
            slidesPerView: 'auto',
        });
    ...
    methods: {
        ...
        nextSlideAppeal() {
            const thumbnailAppeal = document.querySelector('.thumbnailAppeal').swiper;
            thumbnailAppeal.slideNext();
        },
        prevSlideAppeal() {
            const thumbnailAppeal = document.querySelector('.thumbnailAppeal').swiper;
            thumbnailAppeal.slidePrev();
        },
        selectImage(index) {
        ...
        async manageLikeMore() {
            ...
            const newsIndex = this.appealSanstha.findIndex(appeal => appeal.id === this.detail_sanstha.id);
            if (newsIndex !== -1) {
            ...
            if (response.status === 200 || response.status === 201) {
                if (response.data.length > 0) {
                    ...
                    if (this.appeal_page === 1) {
                        this.appealSanstha = response.data;
                    } else {
                        this.appealSanstha = this.appealSanstha.concat(response.data);
                    }
                    $state.loaded();
