<template>
    <section class="mt-2 pb-2">
        <div class="container">
            <label class="section_header p-1 m-1">Events</label>
            <div class="row g-3 my-2 pb-5">
                <div class="col-md-6 col-xxl-4 col-lg-4 col-xl-4 col-sm-12 col-xs-6"
                    v-for='(res, index) in eventSanstha'>
                    <div class="card h-100  card_getallnews p-2">
                        ...
                        <a v-if="token == null" class="read_more p-1 pt-3" @click="navigateFollow()">Read More </a>
                        <a v-else class="read_more p-1 pt-3" data-bs-toggle="modal" data-bs-target="#myEventReadModal"
            ...
            <div class="modal" id="myEventReadModal">
                        ...
                        <div class="modal-body" style="padding-bottom: 0%;">
                            <div class="row">
                                <div class="col-md-12 col-lg-6 col-xl-6 col-xxl-6 col-sm-12 col-xs-12">
                                        ...
                                        <div class="swiper-wrapper">
                                            <div class="swiper slide">
                                                <img src='/images/jd_card_logo.png' class="image_slider img-fluid"
                                                    alt="..." :alt="org_title" :title="org_title">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="swiper thumbnail thumbnailEvent">
                                        <div class="swiper-wrapper">
                                        ...
                                        <div class="next_div" v-if="modelBanner.length > 3" @click="nextSlideEvent"><i
                                                class="bi bi-chevron-right"></i></div>
                                        <div class="prev_div" v-if="modelBanner.length > 3" @click="prevSlideEvent"><i
                                            ...
                                            <div class="card-body p-2 ">
                                                ...
                                                <div  :class="{ 'overflow_auto_dynamic': true, 'overflow_auto_dynamic_data': modelBanner.length > 0 }">
                                                    <p class="card_modal_body_details p-2"
                                                        ...
                                                        <label class="card_modal_date p-2"><img src="/images/ic_timer_24px.svg" class="location_icon mx-2"  alt="..."> {{ formatDate(detail_sanstha.start_date_and_time) + ' - ' + formatDate1(detail_sanstha.end_date_and_time) }}</label>
                                                        <br><label class="card-modal_location p-2 "><img src="/images/ic_place_24px.svg"  class="loation_icon mx-2 " alt="...">{{ detail_sanstha.location }}</label>
                                                </div>
                                                    ...
                                                    <div
                                                        ...
                                                        <div class=" text-center">
                                                            <a class="view_all_latestact"
                                                                ...
                                                                @click.prevent="sendToWhatsApp( org_title  , `/sharepostcard?id=${btoa(detail_sanstha.id)}&type=${btoa(detail_sanstha.type)}` )"
...
export default {
    ...
    data() {
        return {
            event_id: '', token: localStorage.getItem('storeToken'),
            detail_sanstha: {
                banner: [],
                organization: {
                    logo: [],
            ...
            get_sanstha: '', total_count: '', eventSanstha: [], message: '', event_page: 1
        };
    },
    created() {
    ...
    mounted() {
        const thumbnailEvent = new Swiper('.thumbnailEvent', {
            slidesPerView: 'auto',
        });
    ...
    methods: {
        ...
        nextSlideEvent() {
            const thumbnailEvent = document.querySelector('.thumbnailEvent').swiper;
            thumbnailEvent.slideNext();
        },
        prevSlideEvent() {
            const thumbnailEvent = document.querySelector('.thumbnailEvent').swiper;
            thumbnailEvent.slidePrev();
        },
        selectImage(index) {
        ...
        async manageLikeMore() {
            ...
            const newsIndex = this.eventSanstha.findIndex(event => event.id === this.detail_sanstha.id);
            if (newsIndex !== -1) {
            ...
            if (response.status === 200 || response.status === 201) {
                if (response.data.length > 0) {
                    ...
                    if (this.event_page === 1) {
                        this.eventSanstha = response.data;
                    } else {
                        this.eventSanstha = this.eventSanstha.concat(response.data);
                    }
                    $state.loaded();
