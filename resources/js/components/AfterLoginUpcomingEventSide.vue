<template>
    <div class="right_card2 mt-3" v-if="upcomingEvent.length === 0">
                        ...
                        <div class="card h-9 p-2 card_getallnews">
                            ...
                            <div class="row">
                                <div class="col">
                                    <a style="text-decoration: none;">
                                        ...
                                        <span class="d-inline-block text-truncate getallhead" style="max-width: 100px;">{{
                            ...
                            <div class="activity_card_body p-1">
                                ...
                                <br><label class="card_modal_date pt-3"><img src="images/ic_timer_24px.svg"
                                        class="loation_icon me-2" alt="...">{{ res.start_date_and_time }}</label>
                                    ...
                                    <div class="row row-cols-4">
                                        <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 col-xxl-3 col-xl-3">
                                            <div class="text-center" style="margin-left: -45px;">
                                                ...
                                                <br><span class="icon_font">{{ res.total_like == null ? 0 : res.total_like
                                                }}</span>
                                            </div>
                                        </div>
                                        <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 col-xxl-3 col-xl-3">
                                            <div class="text-center" style="margin-left: -21px;">
                                                ...
                                                <br><span v-if="getSaveImageUrl(res) === '/images/ic_add_fav_box_24px.svg'" class="icon_font">Saved Post</span>
